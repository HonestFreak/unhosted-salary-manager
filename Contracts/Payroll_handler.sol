...
import "@unhosted/handlers/BaseHandler.sol"; // Import BaseHandler

contract PayrollManager is Ownable, BaseHandler { // Inherit from BaseHandler
    ...
    // Override the function from BaseHandler
